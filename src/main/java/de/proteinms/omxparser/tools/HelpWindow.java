...
public class HelpWindow extends javax.swing.JFrame {
    ...
    public HelpWindow(java.awt.Frame parent, URL fileName) {
        ...
        try {
            ...
            if (fileName.getPath().endsWith("AboutOmssaViewer.html")) {
                aboutFile = true;
                setTitle("About");
                ...
                setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().
                        getResource("/de/proteinms/omxparser/icons/help.GIF")));
            }
        } catch (Exception e) {

            try {
                textJEditorPane.setPage(getClass().getResource(
                        "/de/proteinms/omxparser/helpfiles/DefaultHelpFile.html"));
            } catch (Exception ex) {
